...
{
    protected CharacterStats characterStats { get; set; }
    ...
    public virtual void OnEnter(StateMachine _stateMachine)
    {
        ...
        if (stateMachine.entityStats != null)
        {
            characterStats = stateMachine.entityStats;
        }
    }
    ...
    {
        //This is for things that must happen in fixed
        fixedtime += Time.deltaTime;
    }
    public virtual void OnLateUpdate()
    {
        //This is helpful for stuff like Camera Movemnt
        latetime += Time.deltaTime;
    }

    public virtual void OnExit()
    {
        //This is where you clean all the variables related to each state
    }

    //These functions are here to pass down and make things functional in unity. 
